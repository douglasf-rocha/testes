...
-- config here
npcwalkname['Tourist - Ja'] = false
npcwalkname['Youth - Tommy'] = false
npcwalkname['Berry'] = false
--[[
...
--[[
npctalkname['Nurse - Gina'] = {
	'Thanks for playing Buccaneers Online, &CHA_NAME!',
	'Hey &CHA_NAME, dont forget to Vote for our Server!',
	'I heard you aint strong yet, &CHA_NAME!',
	'&CHA_NAME, find another Nurse nuub!'
};

npctalkname['Nurse - Tia'] = {
	'Thanks for playing Buccaneers Online, &CHA_NAME!',
	'Hey &CHA_NAME, dont forget to Vote for our Server!',
	'I heard you aint strong yet, &CHA_NAME!',
	'&CHA_NAME, find another Nurse nuub!',
	'&CHA_NAME, i have seen worse dont worry!'
};
]]
