...
FORGE_RATE = {1, 1, 1, 1, 1, 1, 1, 1, 1}
--FORGE_RATE = {1, 1, 1, .8, .7, .7, .7, .7, .7}
MAX_FORGELV = 27

MAX_STONELV	= {}
MAX_STONELV[885] = 9		-- Refining Gem
MAX_STONELV[878] = 9		--Normal Gems
MAX_STONELV[879] = 9
MAX_STONELV[880] = 9
MAX_STONELV[881] = 9
MAX_STONELV[882] = 9
...
MAX_STONELV[884] = 9
MAX_STONELV[887] = 9
MAX_STONELV[860] = 9		-- Unique Gems
MAX_STONELV[861] = 9
MAX_STONELV[862] = 9
MAX_STONELV[863] = 9
MAX_STONELV[1012] = 9
MAX_STONELV[5845] = 8		-- Azrael Gems
MAX_STONELV[5846] = 8
MAX_STONELV[5847] = 8
MAX_STONELV[5848] = 8
MAX_STONELV[5849] = 8
MAX_STONELV[864] = 5		-- BD Gems
MAX_STONELV[865] = 5
MAX_STONELV[866] = 5
MAX_STONELV[6717] = 9		-- Gem of Trial
MAX_STONELV[6718] = 9
MAX_STONELV[6817] = 9		-- Crack/Chipped/Broken
MAX_STONELV[6818] = 9
MAX_STONELV[6819] = 9
MAX_STONELV[6820] = 9
MAX_STONELV[6821] = 9
...
MAX_STONELV[6830] = 9
MAX_STONELV[6831] = 9
MAX_STONELV[6900] = 9		-- Advanced Gems
MAX_STONELV[6901] = 9
MAX_STONELV[6902] = 9	
MAX_STONELV[6903] = 9
MAX_STONELV[6904] = 9 -- lv 5 until here
...
appendgem(878, 4, {11,22,23,24,20,27,0}, ITEMATTR_VAL_MNATK, 3, 1) -- Fiery Gem
appendgem(879, 4, {11,22,23,24,20,27,0}, ITEMATTR_VAL_MNATK, 6, 2) -- Furious Gem
appendgem(880, 4, {11,22,23,24,20,27,0}, ITEMATTR_VAL_MNATK, 7, 3) -- Explosive Gem
appendgem(881, 4, {11,22,23,24,20,27,0}, ITEMATTR_VAL_HIT, 7, 4) -- Lustrious Gem
appendgem(882, 4, {11,22,23,24,20,27,0}, ITEMATTR_VAL_DEF,12, 5) -- Glowing Gem
appendgem(883, 4, {11,22,23,24,20,27,0}, ITEMATTR_VAL_MXHP, 150, 6) -- Shining Gem
appendgem(884, 4, {11,22,23,24,20,27,0}, ITEMATTR_VAL_FLEE, 7, 7) -- Shadow Gem
appendgem(887, 4, {11,22,23,24,20,27,0}, ITEMATTR_VAL_STA, 3, 8) -- Spirit Gem
appendgem(860, 4, {11,22,23,24,20,27,0}, ITEMATTR_VAL_AGI, 5, 9) -- Gem of the Wind
appendgem(861, 4, {11,22,23,24,20,27,0}, ITEMATTR_VAL_DEX, 5, 10) -- Gem of Striking
appendgem(862, 4, {22,20,0}, ITEMATTR_VAL_CON, 5, 11) -- Gem of Colossus
appendgem(863, 4, {1,2,3,4,7,9,0}, ITEMATTR_VAL_STR, 5, 12) -- Gem of Power
appendgem(864, 4, {1,2,3,4,7,9,0}, ITEMATTR_VAL_MNATK, 50, 13) -- Gem of Conqueror
appendgem(865, 4, {22,0}, ITEMATTR_VAL_PDEF, 3, 14) -- Bight Gem (old soul of bd)
appendgem(866, 4, {11,22,23,24,20,27,0}, ITEMATTR_VAL_MXHP, 500, 15) -- Gem of Toughness (old heart of bd)
appendgem(887, 4, {11,22,23,24,20,27,0}, ITEMATTR_VAL_STA, 5, 16) -- Spirit Gem
---appendgem(1012, 4, {26,25,0}, ITEMATTR_VAL_ASPD, 3, 52) --  Gem of Speed (weapons only) (old gem of soul)
appendgem(6817, 4, {24,0}, ITEMATTR_VAL_AGI, 1, 34) -- broken wind
appendgem(6818, 4, {24,0}, ITEMATTR_VAL_AGI, 2, 35) -- crack wind
appendgem(6819, 4, {24,0}, ITEMATTR_VAL_AGI, 3, 36) -- chip wind
appendgem(6820, 4, {23,0}, ITEMATTR_VAL_DEX, 1, 37) -- broken strike
appendgem(6821, 4, {23,0}, ITEMATTR_VAL_DEX, 2, 38) -- crack strike
appendgem(6822, 4, {23,0}, ITEMATTR_VAL_DEX, 3, 39) -- chip strike
appendgem(6823, 4, {27}, ITEMATTR_VAL_CON, 1, 40) -- broken colo
appendgem(6824, 4, {27}, ITEMATTR_VAL_CON, 2, 41) -- crack colo
appendgem(6825, 4, {27}, ITEMATTR_VAL_CON, 3, 42) -- chip colo
appendgem(6826, 4, {1,0}, ITEMATTR_VAL_STR, 1, 43) -- broken rage
appendgem(6827, 4, {1,0}, ITEMATTR_VAL_STR, 2, 44) -- crack rage
appendgem(6828, 4, {1,0}, ITEMATTR_VAL_STR, 3, 45) -- chip rage
appendgem(6829, 4, {1,0}, ITEMATTR_VAL_STA, 1, 46) -- broken rage
appendgem(6830, 4, {1,0}, ITEMATTR_VAL_STA, 2, 47) -- crack rage
appendgem(6831, 4, {1,0}, ITEMATTR_VAL_STA, 3, 48) -- chip rage
appendgem(6900, 4, {20,0}, ITEMATTR_VAL_CRT, 10, 49) -- Chiatan's Aura
appendgem(6901, 4, {23,0}, ITEMATTR_VAL_HIT, 10, 50) -- Lock's Hit
appendgem(6902, 4, {24,0}, ITEMATTR_VAL_FLEE, 10, 51) -- Bing's Dodging
appendgem(6903, 4, {20,0}, ITEMATTR_VAL_ASPD, 15, 52) -- Att-Speed Gem
appendgem(6904, 4, {24,0}, ITEMATTR_VAL_MSPD, 15, 53) -- Movement-Speed Gem
appendgem(5845, 4, {1,2,3,4,7,9,0}, ITEMATTR_VAL_STR, 8, 54) -- Azrael Glare
appendgem(5846, 4, {22,0}, ITEMATTR_VAL_CON, 8, 55) -- Azrael Undead
appendgem(5847, 4, {11,22,23,24,20,27,0}, ITEMATTR_VAL_AGI, 8, 56) -- Azrael Dance
appendgem(5848, 4, {11,22,23,24,20,27,0}, ITEMATTR_VAL_DEX, 8, 57) -- Azrael Aggr
appendgem(5849, 4, {11,22,23,24,20,27,0}, ITEMATTR_VAL_STA, 8, 58) -- Azrael Light	
...
function can_forge_item_main ( Table )
	...
	if getGemLv >= MAX_FORGELV then
		SystemNotice(role, "The game currently capped forging at +"..MAX_FORGELV.." Equipment!")
		return 0
	end
	local Item_Stone1 = GetChaItem ( role , 2 , ItemBag [1] )
	local Item_Stone2 = GetChaItem ( role , 2 , ItemBag [2] )
