...
-- Sharpshooter Bows
unsealup[10500]	= { -- Bow of the Cursed
	[10144] 	= {	[ITEMATTR_VAL_MNATK]= 215,
					[ITEMATTR_VAL_MXATK]= 255,
					[ITEMATTR_COE_ASPD]	= 35,
					[ITEMATTR_VAL_DEX]	= 5,
					[ITEMATTR_VAL_HIT]	= 15 },
	[10145] 	= {	[ITEMATTR_VAL_MNATK]= 201,
					[ITEMATTR_VAL_MXATK]= 231,
					[ITEMATTR_COE_ASPD]	= 20,
					[ITEMATTR_VAL_CON]	= 4,
					[ITEMATTR_VAL_FLEE]	= 5,
					[ITEMATTR_VAL_HREC]	= 6,
					[ITEMATTR_VAL_STA]	= 0 }}
unsealup[10501]	= { -- Bow of Evanescence
	[10146] 	= {	[ITEMATTR_VAL_MNATK]= 245,
					[ITEMATTR_VAL_MXATK]= 295,
					[ITEMATTR_COE_ASPD]	= 55,
					[ITEMATTR_VAL_DEX]	= 8,
					[ITEMATTR_VAL_HIT]	= 25 },
	[10147] 	= {	[ITEMATTR_VAL_MNATK]= 225,
					[ITEMATTR_VAL_MXATK]= 262,
					[ITEMATTR_COE_ASPD]	= 40,
					[ITEMATTR_VAL_CON]	= 7,
					[ITEMATTR_VAL_FLEE]	= 8,
					[ITEMATTR_VAL_HREC]	= 8,
					[ITEMATTR_VAL_STA]	= 0 }}
unsealup[10502]	= { -- Bow of Enigma
	[10148] 	= {	[ITEMATTR_VAL_MNATK]= 275,
					[ITEMATTR_VAL_MXATK]= 315,
					[ITEMATTR_COE_ASPD]	= 55,
					[ITEMATTR_VAL_DEX]	= 10,
					[ITEMATTR_VAL_HIT]	= 32 },
	[10149] 	= {	[ITEMATTR_VAL_MNATK]= 235,
					[ITEMATTR_VAL_MXATK]= 290,
					[ITEMATTR_COE_ASPD]	= 40,
					[ITEMATTR_VAL_CON]	= 10,
					[ITEMATTR_VAL_FLEE]	= 11,
					[ITEMATTR_VAL_HREC]	= 10,
					[ITEMATTR_VAL_STA]	= 0 }}
-- Crusader
...
function tichun_item(Table)
	...
	if IsAwakened == 1 then
		...
		if awakeType ~= nil and awakeName ~= nil then
			...
			LG('Awaken Mode','Congratulations, ['..GetChaDefaultName(Player)..'] awakened [ '..GetItemName(ItemMainID)..' ] to [ '..awakeName..' ] mode!')
		end
	else -- END CUSTOM
		...
		LG('Awaken Info','Congratulations, ['..GetChaDefaultName(Player)..'] upgraded [ '..GetItemName(ItemMainID)..' ] with [ '..GetItemName(ItemCatalystID)..' ] and obtained [ '..GetItemName(MainID)..' ]!')
	end
