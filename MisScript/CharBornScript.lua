...
function PCBorn ()
	...
	TriggerAction( 1, ObligeAcceptMission, 31)
	TriggerCondition( 2, IsSpawnPos, "Shaitan City" )
	TriggerAction( 2, ObligeAcceptMission, 1 )
	TriggerAction( 2, ObligeAcceptMission, 31)
	TriggerCondition( 3, IsSpawnPos, "Icicle Castle" )
	TriggerAction( 3, ObligeAcceptMission, 1 )
	TriggerAction( 3, ObligeAcceptMission, 31)
