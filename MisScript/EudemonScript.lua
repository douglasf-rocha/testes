...
function EudemonMission()
	...
	DefineWorldMission( 1, "Adventure Start!", 1 )
	
	MisBeginTalk( "<t>You've arrived from another continent to search work as mercenary within of the Ascaronian territory having heard that this continent is undergoing many changes and there's an ongoing war between the Navy and the Pirates. This situation has intrigued you enough to start your perilous journey that brought you to Ascaron Continent." )
	MisHelpTalk( "<t>You've arrived from another continent to search work as mercenary within of the Ascaronian territory having heard that this continent is undergoing many changes and there's an ongoing war between the Navy and the Pirates. This situation has intrigued you enough to start your perilous journey that brought you to Ascaron Continent.<n><t>I must show my former Guild's presentation letter to someone with the proper authority in town." )
	MisBeginAction( AddMission, 1 )
	MisBeginAction( SetFlag, 1, 1 )
	MisNeed(MIS_NEED_DESP, "Speak with <rSenna> at (2223, 2785)")


	MisResultCondition( AlwaysFailure )

	DefineWorldMission( 2, "Adventure Start!", 2 )
	...
	MisNeed(MIS_NEED_DESP, "Speak with <rShirley> at (2239, 2826)")

	MisResultCondition( AlwaysFailure )
	
	DefineWorldMission( 3, "Adventure Start!", 3 )
...
-----------------------------------
	...
	MisResultCondition( AlwaysFailure )
-----------------------------------------------------------
	DefineWorldMission(31, "Adventure Start!", 31)
	
	MisBeginTalk("<t>You've arrived from another continent to search work as mercenary within of the Ascaronian territory having heard that this continent is undergoing many changes and there's an ongoing war between the Navy and the Pirates. This situation has intrigued you enough to start your perilous journey that brought you to Ascaron Continent. ")
	MisHelpTalk("I must show my former guild's presentation letter to someone with the proper authority in town.")
	MisBeginAction(AddMission, 31)
	MisCancelAction(SystemNotice, "This quest cannot be abandoned.")		
	MisNeed(MIS_NEED_DESP, "Speak with <rShirley> at <y(2246,2835)>.")
