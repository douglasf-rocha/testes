...
-- é necessário adaptar os valores de EXP_TO_LEVEL_55 e EXP_TO_LEVEL_100 de acordo com a sua vers?o do servidor.

-- Defina os valores de experiência necessários para atingir os níveis desejados.
-- Estes s?o valores PLACEHOLDER. Você DEVE substituí-los pelos valores corretos do seu servidor.
...
function lvl_func()
	...
	Talk(1, "Olá, aventureiro! Deseja acelerar sua jornada e atingir um novo patamar de poder?")
    InitTrigger()
    Text(1, "Sim! Leve-me para o Nível 55!", JumpPage, 2) -- Op??o: Ir para Nível 55
	Text(1, "Sim! Leve-me para o Nível 100!", JumpPage, 3) -- Op??o: Ir para Nível 100
    Text(1, "N?o, obrigado. Prefiro evoluir no meu próprio ritmo.", CloseTalk) -- Op??o: Cancelar
	
	-- Página 2: Confirmar Nível 55
    Talk(2, "Você tem certeza que deseja ir para o Nível 55? Esta a??o é irreversível.")
    InitTrigger()	
    TriggerCondition(1, LvCheck, "<", 100) -- Condi??o: Jogador já é Nível 100 ou superior
    ...
    Talk(3, "Você tem certeza que deseja ir para o Nível 100? Esta a??o é irreversível.")
    InitTrigger()	
    TriggerCondition(1, LvCheck, "<", 100) -- Condi??o: Jogador já é Nível 100 ou superior
