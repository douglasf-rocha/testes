...
function Check_CG_HechengBS ( Item_Lv , Item_Type , Sklv )
	...
	local b = 0
	Item_Lv = Item_Lv - 1
	if Item_Type == 49 then--All Gems
		a = 1 --a = math.max ( 0 , math.min ( 1 , ( 1 - Item_Lv * 0.10 + Sklv * 0.10 ) ) )
		b = Percentage_Random ( a )
		if Item_Lv < 3 then
			b = 1
		end
		return b
	elseif Item_Type == 50 then--Ref Gem
		a = 1 --a = math.max ( 0 , math.min ( 1 , ( 1 - Item_Lv * 0.05 + Sklv * 0.15 ) ) )
		b = Percentage_Random ( a )
		return b
	else
...
function GetChaName_26 ( role,npc )
	...
	if Money_Have >= Money_Need and item_num >0 then
		...
		TakeItem( role, 0,2887, 1 )
		PlayEffect( npc, 361 )
		Notice(""..cha_name.."���쳤̾���ܲ������¸�ʥ����֮ǰ�������ҵ��Ҷ�֮��,����ս��Ҫ�δζ�Ӯ,����,������һ��ǿ���Ķ��ְ�,����......")
		else
	end
end
...
--	Notice("Forging completed")
	...
	local cha_name = GetChaDefaultName ( role )
	LG( "JingLian_ShiBai" , "Player "..cha_name.." Socket Fusion successful" )
...
function Check_Jiaguji1 ( Item_Cailiao1 , Item_Cailiao2 )
	local ItemID_Cailiao1 = GetItemID ( Item_Cailiao1 )
	local ItemID_Cailiao2 = GetItemID ( Item_Cailiao2 )
	
	if ItemID_Cailiao1 == 15733 then
		return 1
	elseif ItemID_Cailiao2 == 15733 then
		return 1
	end
	return 0
end
function Check_Cuihuafen1 ( Item_Cailiao1 , Item_Cailiao2 )

	local ItemID_Cailiao1 = GetItemID ( Item_Cailiao1 )
	local ItemID_Cailiao2 = GetItemID ( Item_Cailiao2 )

	if ItemID_Cailiao1 == 15734 then
		return 1
	elseif ItemID_Cailiao2 == 15734 then
		return 1
	end
	
	return 0
end
function Check_Jiaguji2 ( Item_Cailiao1 , Item_Cailiao2 )
	local ItemID_Cailiao1 = GetItemID ( Item_Cailiao1 )
	local ItemID_Cailiao2 = GetItemID ( Item_Cailiao2 )
	
	if ItemID_Cailiao1 == 15735 then
		return 1
	elseif ItemID_Cailiao2 == 15735 then
		return 1
	end
	return 0
end
function Check_Cuihuafen2 ( Item_Cailiao1 , Item_Cailiao2 )

	local ItemID_Cailiao1 = GetItemID ( Item_Cailiao1 )
	local ItemID_Cailiao2 = GetItemID ( Item_Cailiao2 )

	if ItemID_Cailiao1 == 15736 then
		return 1
	elseif ItemID_Cailiao2 == 15736 then
		return 1
	end
...
function getfusion_money_main ( Table )
	...
	local Money_Need = Shuxing_Lv * 50000
...
function begin_upgrade_item (...)
	...
	local cha_name = GetChaDefaultName ( role )
	local Item_Strength1_name = GetItemName ( Item_ScItem_ID )
	local Item_Strength2_name = GetItemName ( Item_YxItem_ID )
	LG( "JingLian_ShiBai" , "Player "..cha_name.." Strengthening successful; Strength 1: "..Item_Strength1_name.." and Strength 2: "..Item_Strength2_name.."!")
...
function end_manufacture_item (...)
	...
	role , ItemBag , ItemBagCount = Read_manufacture ( arg )
	--Notice( "Final results arg[#arg]=="..arg[#arg])
	--Notice( "Final acquisition #arg=="..#arg)
...
function GetChaName1_born ( role,npc )
	...
	if cha_type~=1 and cha_type~=3 and cha_type~=4 then
		SystemNotice( role ,"Only Lance, Phyllis and Ami can be Crusader")
		return
	end
...
function GetChaName_born ( role )
	...
	--PlayEffect( npc, 361 )
	PlayEffect( npc, 361 )
	ScrollNotice("Extreme celebration, ["..cha_name.."] Rebirth successful. Blessing from the whole server ["..cha_name.."] Hope you have a safe journey and everything goes your way!", 2)
	return 1
end
