...
function can_beuplv_item_main ( Table )
	...
	if Item_YxItem_Type ~= 63 and Item_YxItem_ID ~= 15744 then
...
function begin_upgrade_item (...)
	...
	local Item_ScItem_ID = GetItemID ( Item_ScItem )		
	local Item_YxItem_ID = GetItemID ( Item_YxItem )
	local Item_STRitem_ID = GetItemID ( Item_beuplv )		
	...
	LG( "JingLian_ShiBai" , "Player "..cha_name.." Strengthening successful; System took "..Item_Strength1_name.." and "..Item_Strength2_name.." and added Strength on Item ID: "..Item_STRitem_ID.."!")
